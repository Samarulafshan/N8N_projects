...
✂️ Summarization Node (GPT-4) → summarizes the review in 3–4 lines
...
⏸️ The workflow is currently set to active: false — activate it in n8n after importing and configuring credentials.
